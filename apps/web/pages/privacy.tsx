      ...
      <div className="flex justify-center items-center p-12 pt-32 w-screen min-h-screen py-8 xl:py-[10rem]">
        <article className="prose">
          ...
          <p>
            ...
            that they shared and/or collect in Remark. This policy is not
          ...
          <p>
            ...
            advertising partners of Remark.
          </p>
          <p>
          ...
          <p>
            Note that Remark has no access to or control over these cookies that
          ...
          <p>
            Remark does not knowingly collect any Personal Identifiable
